...
export default function Discount() {
  return (
    <section className='discount-container'>
        ...
        <img className="discount-image" src="/image/discount-image.png" alt="new car"/>
        <img className="discount-image-max-width-750" src="/image/discount-image.png" alt="new car"/>
    </section>
  )
}
